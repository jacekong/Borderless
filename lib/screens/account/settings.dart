            ...
            builder: (context, userProfileProvider, _) {
              final UserProfile? userProfile = userProfileProvider.userProfile;
               if (userProfile != null) {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text("更新資料", style: TextStyle(color: Theme.of(context).colorScheme.secondary,),),
                      ),
                    ),
                    const Padding(
                        ...
                        if (snapshot.connectionState == ConnectionState.waiting) {
                          ...
                          return Expanded(
                            child: GestureDetector(
                              onTap: () => _refreshPosts(),
                              child: const Center(
                                child: Icon(Icons.escalator_warning_rounded, size: 30,),
                              ),
                            ),
                          );
                        } else {
                ...
                return const Center(child: Text('系統崩潰啦。。。')); // or any other loading indicator
              }
            }
