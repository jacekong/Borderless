      ...
      body: Column(
        ...
        children: [
              ...
              Padding(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: NetworkImage(
                      widget.userProfile.avatar), // Use NetworkImage
                ),
              ),
            ],
          ),
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: Text(
                "${AppLocalizations.of(context)!.bio}: ${widget.userProfile.bio}"),
          ),
          // edit profile,
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            ChatPage(friend: widget.userProfile)));
              },
              child: Text(
                        ...
                        child: post.postImages
                            ...
                            ? CachedNetworkImage(
                                ...
                                placeholder: (context, url) => Container(
                                  ...
                                  child:
                                      const Center(child: PixelPlaceholder()),
                                ),
