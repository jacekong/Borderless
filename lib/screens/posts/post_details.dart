...
class _PostDetailsState extends State<PostDetails> {
  ...
  void _handleCommentsReceived(Map<String, dynamic> message) {
    final userDataProvider = Provider.of<UserProfileProvider>(context, listen: false);
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        title: Padding(
                          ...
                          child: Text(comment['username'], style: const TextStyle(fontSize: 14,fontWeight: FontWeight.w600)),
                        ),
                        subtitle: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
